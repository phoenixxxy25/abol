...
<small>Дата статьи: <?php echo e($post->updated_at); ?></small>
<div class="panel-body">
...
<?php foreach($images as $image): ?>
        <div>
        	<?php echo e(Html::image('/images/'.$image->post_id.'/'.$image->filename, $alt="Photo", $attributes = array('width'=>'650', 'height'=>'380'))); ?>
