                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address" value="" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control" name="city" value="" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="state" type="text" class="form-control" name="state" value="" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control" name="country" value="" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="pzip" type="text" class="form-control" name="pzip" value="" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
