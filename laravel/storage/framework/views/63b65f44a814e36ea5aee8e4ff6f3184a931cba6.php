        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php if(Request::session()->get('regist_error')): ?>
                        <h1 class="h1Err"><?php echo e(Session::pull('regist_error')); ?></h1>
                    <?php endif; ?>
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="login" type="text" class="form-control" name="login" value="" maxlength="30" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="full_name" type="text" class="form-control" name="full_name" value="" maxlength="30" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="email" type="email" class="form-control" name="email" value="" maxlength="30" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="password" maxlength="30" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" maxlength="30" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address" value="" maxlength="30" placeholder="Не обязательно" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control" name="city" value="" maxlength="20" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="state" type="text" class="form-control" name="state" value="" maxlength="20" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control" name="country" value="" maxlength="20" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="pzip" type="text" class="form-control" name="pzip" value="" maxlength="10" placeholder="Не обязательно">
                            </div>
                        </div>
                        <div class="form-group">
